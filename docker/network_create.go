...
func (cm *onceNetworkCreateOp) Exec(ctx context.CancelContext, m metrics.Metrics) error {
	return cm.spell.Exec(ctx, m, cm.callback)
}

// Exec executes the image creation for the underline docker server pointed to.
func (cm *NetworkCreateOp) Exec(ctx context.CancelContext, m metrics.Metrics, callback NetworkCreateResponseCallback) error {
	if cm.client == nil {
