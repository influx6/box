...
func (cm *oncebuildImageSpell) Exec(ctx context.CancelContext) error {
...
func (cm *BuildImageSpell) Exec(ctx context.CancelContext, callback BuildImageResponseCallback) error {
	if cm.client == nil {
