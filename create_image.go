...
func AlwaysCreateImageSpellWith(bm *CreateImageSpell, cb CreateImageResponseCallback) Spell {
...
func (cm *onceCreateImageSpell) Exec(ctx CancelContext) error {
...
func (cm *CreateImageSpell) Exec(ctx CancelContext, callback CreateImageResponseCallback) error {
